...
using namespace std;
  ...
  for (i=0; i<pow16   ; i++) {
    ...
    sum15 = pow33*s33_h15+pow32*s32_h15+pow31*s31_h15+pow30*s30_h15
      +pow29*s29_h15+pow28*s28_h15+pow27*s27_h15+pow26*s26_h15+pow25*s25_h15+pow24*s24_h15+pow23*s23_h15+pow22*s22_h15+pow21*s21_h15+pow20*s20_h15
      +pow19*s19_h15+pow18*s18_h15+pow17*s17_h15+pow16*s16_h15+pow15*s15_h15+pow14*s14_h15+pow13*s13_h15+pow12*s12_h15+pow11*s11_h15+pow10*s10_h15
      +pow09*s9_h15+pow08*s8_h15+pow07*s7_h15+pow06*s6_h15+pow05*s5_h15+pow04*s4_h15+pow03*s3_h15+pow02*s2_h15+pow01*s1_h15+pow00*s0_h15 
